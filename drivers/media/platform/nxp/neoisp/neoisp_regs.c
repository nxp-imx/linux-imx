...
/* array of all fields offsets for NEO V1 */
const int neoisp_fields_a_v1[NEOISP_FIELD_COUNT] = {
	...
	NEO_PIPE_CONF_INT_EN0_V1,
	NEO_PIPE_CONF_INT_STAT0_V1,
	NEO_PIPE_CONF_CSI_STAT_V1,
	NEO_HC_CTRL_CAM0,
...
/* array of all fields offsets for NEO V2 */
const int neoisp_fields_a_v2[NEOISP_FIELD_COUNT] = {
	NEO_PIPE_CONF_SOFT_RESET,
	NEO_PIPE_CONF_BUS_TXPARAM,
	NEO_PIPE_CONF_REG_XFR_DIS,
	NEO_PIPE_CONF_CSI_CTRL,
	...
	NEO_PIPE_CONF_OUTIR_LS_CAM0,
	NEO_PIPE_CONF_SKIP_CTRL0,
	NEO_PIPE_CONF_INT_EN0_V2,
	NEO_PIPE_CONF_INT_STAT0_V2,
	NEO_PIPE_CONF_CSI_STAT_V2,
	NEO_HC_CTRL_CAM0,
	NEO_HDR_DECOMPRESS0_CTRL_CAM0,
	NEO_HDR_DECOMPRESS0_KNEE_POINT1_CAM0,
	NEO_HDR_DECOMPRESS0_KNEE_POINT2_CAM0,
