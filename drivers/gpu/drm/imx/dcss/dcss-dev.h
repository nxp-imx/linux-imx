...
static inline void trusty_dcss_set_display_mode(struct device *dev, u32 param1, u32 param2, u32 param3) {
        trusty_fast_call32(dev, SMC_INIT_DISPLAY_PARAM, param1, param2, param3);
}
