...
static void kbase_regmap_v14_10_init(struct kbase_device *kbdev)
{
	if (kbdev->regmap.regs == NULL && kbdev->regmap.flags == NULL) {
		kbdev->regmap.size = NR_V14_10_REGS;
		kbdev->regmap.regs =
			kcalloc(kbdev->regmap.size, sizeof(void __iomem *), GFP_KERNEL);
		kbdev->regmap.flags = kcalloc(kbdev->regmap.size, sizeof(u32), GFP_KERNEL);
	}
	...
	kbase_regmap_v14_8_init(kbdev);

	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_IRQ_CLEAR] = KBASE_REGMAP_WIDTH_32_BIT |
								KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_IRQ_MASK] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_IRQ_RAWSTAT] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_IRQ_STATUS] = KBASE_REGMAP_WIDTH_32_BIT |
								 KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_MESSAGE__AM_INCOMING_MESSAGE0] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_MESSAGE__AM_INCOMING_MESSAGE1] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE0] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE1] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE_STATUS] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_STATUS] = KBASE_REGMAP_WIDTH_32_BIT |
							     KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__CYCLE_COUNT] = KBASE_REGMAP_WIDTH_64_BIT |
							KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__GPU_COMMAND] = KBASE_REGMAP_WIDTH_32_BIT |
	...
	kbdev->regmap.flags[MMU_CONTROL__AS9__TRANSTAB] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__TEXTURE_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__AMBA_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__CORE_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__DOORBELL_FEATURES] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__GPU_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__GPU_ID] = KBASE_REGMAP_WIDTH_64_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__L2_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__MCU_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__MEM_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__MMU_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__PRFCNT_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__REVIDR] = KBASE_REGMAP_WIDTH_64_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC0] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC1] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC2] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC3] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC4] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC5] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC6] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_ALLOC7] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_PBHA_OVERRIDE0] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_PBHA_OVERRIDE1] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_PBHA_OVERRIDE2] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[MMU_CONTROL__SYSC_PBHA_OVERRIDE3] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_FEATURES] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_BARRIER_SIZE] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_THREADS] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_WORKGROUP_SIZE] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__TILER_FEATURES] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__AMBA_ENABLE] = 0;
	kbdev->regmap.flags[GPU_CONTROL__AS_PRESENT] = 0;
	kbdev->regmap.flags[GPU_CONTROL__CSF_CONFIG] = 0;
	kbdev->regmap.flags[GPU_CONTROL__L2C_SLICE_HASH_0] = 0;
	kbdev->regmap.flags[GPU_CONTROL__L2C_SLICE_HASH_1] = 0;
	kbdev->regmap.flags[GPU_CONTROL__L2C_SLICE_HASH_2] = 0;
	kbdev->regmap.flags[GPU_CONTROL__L2_CONFIG] = 0;
	kbdev->regmap.flags[GPU_CONTROL__L2_MMU_CONFIG] = 0;
	kbdev->regmap.flags[GPU_CONTROL__NEURAL_CONFIG] = 0;
	kbdev->regmap.flags[GPU_CONTROL__PWR_KEY] = 0;
	kbdev->regmap.flags[GPU_CONTROL__PWR_OVERRIDE0] = 0;
	kbdev->regmap.flags[GPU_CONTROL__PWR_OVERRIDE1] = 0;
	kbdev->regmap.flags[GPU_CONTROL__SHADER_CONFIG] = 0;
	kbdev->regmap.flags[GPU_CONTROL__TEXTURE_FEATURES_1] = 0;
	kbdev->regmap.flags[GPU_CONTROL__TEXTURE_FEATURES_2] = 0;
	kbdev->regmap.flags[GPU_CONTROL__TEXTURE_FEATURES_3] = 0;
	kbdev->regmap.flags[GPU_CONTROL__TILER_CONFIG] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_CORE_MASK] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_FEATURES] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__COMMAND] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_CSHW] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_MEMSYS] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_NEURAL] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_SHADER] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_TILER] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__STATUS] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__TIMER] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_0] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_1] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_2] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_3] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_4] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_5] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_6] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_7] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_0] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_1] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_2] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_3] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_4] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_5] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_6] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_7] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_0] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_1] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_2] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_3] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_4] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_5] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_6] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_0] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_1] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_2] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_3] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_4] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_5] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_6] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_7] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_0] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_1] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_2] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_3] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_4] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_5] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_6] = 0;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_7] = 0;

	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_IRQ_CLEAR] = kbdev->reg + 0x444;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_IRQ_MASK] = kbdev->reg + 0x448;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_IRQ_RAWSTAT] = kbdev->reg + 0x440;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_IRQ_STATUS] = kbdev->reg + 0x44c;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_MESSAGE__AM_INCOMING_MESSAGE0] =
		kbdev->reg + 0x460;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_MESSAGE__AM_INCOMING_MESSAGE1] =
		kbdev->reg + 0x464;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE0] =
		kbdev->reg + 0x46c;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE1] =
		kbdev->reg + 0x470;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE_STATUS] =
		kbdev->reg + 0x468;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_STATUS] = kbdev->reg + 0x43c;
	kbdev->regmap.regs[GPU_CONTROL__CYCLE_COUNT] = kbdev->reg + 0x3090;
	kbdev->regmap.regs[GPU_CONTROL__GPU_COMMAND] = kbdev->reg + 0x3030;
	kbdev->regmap.regs[GPU_CONTROL__GPU_COMMAND_ARG0] = kbdev->reg + 0x30d0;
	kbdev->regmap.regs[GPU_CONTROL__GPU_COMMAND_ARG1] = kbdev->reg + 0x30d8;
	kbdev->regmap.regs[GPU_CONTROL__GPU_FAULTADDRESS] = kbdev->reg + 0x3040;
	kbdev->regmap.regs[GPU_CONTROL__GPU_FAULTSTATUS] = kbdev->reg + 0x303c;
	kbdev->regmap.regs[GPU_CONTROL__GPU_IRQ_CLEAR] = kbdev->reg + 0x3024;
	kbdev->regmap.regs[GPU_CONTROL__GPU_IRQ_MASK] = kbdev->reg + 0x3028;
	kbdev->regmap.regs[GPU_CONTROL__GPU_IRQ_RAWSTAT] = kbdev->reg + 0x3020;
	kbdev->regmap.regs[GPU_CONTROL__GPU_IRQ_STATUS] = kbdev->reg + 0x302c;
	kbdev->regmap.regs[GPU_CONTROL__GPU_STATUS] = kbdev->reg + 0x3034;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_PRESENT] = kbdev->reg + 0x3b80;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_PWRACTIVE] = kbdev->reg + 0x3b98;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_PWRTRANS] = kbdev->reg + 0x3b90;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_READY] = kbdev->reg + 0x3b88;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_PRESENT] = kbdev->reg + 0x3900;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_PWRACTIVE] = kbdev->reg + 0x3918;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_PWRTRANS] = kbdev->reg + 0x3910;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_READY] = kbdev->reg + 0x3908;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_PRESENT] = kbdev->reg + 0x3a40;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_PWRACTIVE] = kbdev->reg + 0x3a58;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_PWRTRANS] = kbdev->reg + 0x3a50;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_READY] = kbdev->reg + 0x3a48;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_CMDARG] = kbdev->reg + 0x3830;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_COMMAND] = kbdev->reg + 0x3828;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_CLEAR] = kbdev->reg + 0x3804;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_MASK] = kbdev->reg + 0x3808;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_RAWSTAT] = kbdev->reg + 0x3800;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_STATUS] = kbdev->reg + 0x380c;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_STATUS] = kbdev->reg + 0x3820;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_PRESENT] = kbdev->reg + 0x3a00;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_PWRACTIVE] = kbdev->reg + 0x3a18;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_PWRTRANS] = kbdev->reg + 0x3a10;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_READY] = kbdev->reg + 0x3a08;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__STACK_PRESENT] = kbdev->reg + 0x3bc0;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__STACK_PWRTRANS] = kbdev->reg + 0x3bd0;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__STACK_READY] = kbdev->reg + 0x3bc8;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_PRESENT] = kbdev->reg + 0x3940;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_PWRACTIVE] = kbdev->reg + 0x3958;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_PWRTRANS] = kbdev->reg + 0x3950;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_READY] = kbdev->reg + 0x3948;
	kbdev->regmap.regs[GPU_CONTROL__MCU_CONTROL] = kbdev->reg + 0x3100;
	kbdev->regmap.regs[GPU_CONTROL__MCU_STATUS] = kbdev->reg + 0x3104;
	kbdev->regmap.regs[GPU_CONTROL__NEURAL_CONTROL] = kbdev->reg + 0x3200;
	kbdev->regmap.regs[GPU_CONTROL__TIMESTAMP] = kbdev->reg + 0x3098;
	kbdev->regmap.regs[GPU_CONTROL__TIMESTAMP_OFFSET] = kbdev->reg + 0x3088;
	kbdev->regmap.regs[MMU_CONTROL__AS0__COMMAND] = kbdev->reg + 0x2818;
	kbdev->regmap.regs[MMU_CONTROL__AS0__FAULTADDRESS] = kbdev->reg + 0x2820;
	kbdev->regmap.regs[MMU_CONTROL__AS0__FAULTSTATUS] = kbdev->reg + 0x281c;
	kbdev->regmap.regs[MMU_CONTROL__AS0__LOCKADDR] = kbdev->reg + 0x2810;
	kbdev->regmap.regs[MMU_CONTROL__AS0__MEMATTR] = kbdev->reg + 0x2808;
	kbdev->regmap.regs[MMU_CONTROL__AS0__STATUS] = kbdev->reg + 0x2828;
	kbdev->regmap.regs[MMU_CONTROL__AS0__TRANSCFG] = kbdev->reg + 0x2830;
	kbdev->regmap.regs[MMU_CONTROL__AS0__TRANSTAB] = kbdev->reg + 0x2800;
	kbdev->regmap.regs[MMU_CONTROL__AS10__COMMAND] = kbdev->reg + 0x2d18;
	kbdev->regmap.regs[MMU_CONTROL__AS10__FAULTADDRESS] = kbdev->reg + 0x2d20;
	kbdev->regmap.regs[MMU_CONTROL__AS10__FAULTSTATUS] = kbdev->reg + 0x2d1c;
	kbdev->regmap.regs[MMU_CONTROL__AS10__LOCKADDR] = kbdev->reg + 0x2d10;
	kbdev->regmap.regs[MMU_CONTROL__AS10__MEMATTR] = kbdev->reg + 0x2d08;
	kbdev->regmap.regs[MMU_CONTROL__AS10__STATUS] = kbdev->reg + 0x2d28;
	kbdev->regmap.regs[MMU_CONTROL__AS10__TRANSCFG] = kbdev->reg + 0x2d30;
	kbdev->regmap.regs[MMU_CONTROL__AS10__TRANSTAB] = kbdev->reg + 0x2d00;
	kbdev->regmap.regs[MMU_CONTROL__AS11__COMMAND] = kbdev->reg + 0x2d98;
	kbdev->regmap.regs[MMU_CONTROL__AS11__FAULTADDRESS] = kbdev->reg + 0x2da0;
	kbdev->regmap.regs[MMU_CONTROL__AS11__FAULTSTATUS] = kbdev->reg + 0x2d9c;
	kbdev->regmap.regs[MMU_CONTROL__AS11__LOCKADDR] = kbdev->reg + 0x2d90;
	kbdev->regmap.regs[MMU_CONTROL__AS11__MEMATTR] = kbdev->reg + 0x2d88;
	kbdev->regmap.regs[MMU_CONTROL__AS11__STATUS] = kbdev->reg + 0x2da8;
	kbdev->regmap.regs[MMU_CONTROL__AS11__TRANSCFG] = kbdev->reg + 0x2db0;
	kbdev->regmap.regs[MMU_CONTROL__AS11__TRANSTAB] = kbdev->reg + 0x2d80;
	kbdev->regmap.regs[MMU_CONTROL__AS12__COMMAND] = kbdev->reg + 0x2e18;
	kbdev->regmap.regs[MMU_CONTROL__AS12__FAULTADDRESS] = kbdev->reg + 0x2e20;
	kbdev->regmap.regs[MMU_CONTROL__AS12__FAULTSTATUS] = kbdev->reg + 0x2e1c;
	kbdev->regmap.regs[MMU_CONTROL__AS12__LOCKADDR] = kbdev->reg + 0x2e10;
	kbdev->regmap.regs[MMU_CONTROL__AS12__MEMATTR] = kbdev->reg + 0x2e08;
	kbdev->regmap.regs[MMU_CONTROL__AS12__STATUS] = kbdev->reg + 0x2e28;
	kbdev->regmap.regs[MMU_CONTROL__AS12__TRANSCFG] = kbdev->reg + 0x2e30;
	kbdev->regmap.regs[MMU_CONTROL__AS12__TRANSTAB] = kbdev->reg + 0x2e00;
	kbdev->regmap.regs[MMU_CONTROL__AS13__COMMAND] = kbdev->reg + 0x2e98;
	kbdev->regmap.regs[MMU_CONTROL__AS13__FAULTADDRESS] = kbdev->reg + 0x2ea0;
	kbdev->regmap.regs[MMU_CONTROL__AS13__FAULTSTATUS] = kbdev->reg + 0x2e9c;
	kbdev->regmap.regs[MMU_CONTROL__AS13__LOCKADDR] = kbdev->reg + 0x2e90;
	kbdev->regmap.regs[MMU_CONTROL__AS13__MEMATTR] = kbdev->reg + 0x2e88;
	kbdev->regmap.regs[MMU_CONTROL__AS13__STATUS] = kbdev->reg + 0x2ea8;
	kbdev->regmap.regs[MMU_CONTROL__AS13__TRANSCFG] = kbdev->reg + 0x2eb0;
	kbdev->regmap.regs[MMU_CONTROL__AS13__TRANSTAB] = kbdev->reg + 0x2e80;
	kbdev->regmap.regs[MMU_CONTROL__AS14__COMMAND] = kbdev->reg + 0x2f18;
	kbdev->regmap.regs[MMU_CONTROL__AS14__FAULTADDRESS] = kbdev->reg + 0x2f20;
	kbdev->regmap.regs[MMU_CONTROL__AS14__FAULTSTATUS] = kbdev->reg + 0x2f1c;
	kbdev->regmap.regs[MMU_CONTROL__AS14__LOCKADDR] = kbdev->reg + 0x2f10;
	kbdev->regmap.regs[MMU_CONTROL__AS14__MEMATTR] = kbdev->reg + 0x2f08;
	kbdev->regmap.regs[MMU_CONTROL__AS14__STATUS] = kbdev->reg + 0x2f28;
	kbdev->regmap.regs[MMU_CONTROL__AS14__TRANSCFG] = kbdev->reg + 0x2f30;
	kbdev->regmap.regs[MMU_CONTROL__AS14__TRANSTAB] = kbdev->reg + 0x2f00;
	kbdev->regmap.regs[MMU_CONTROL__AS15__COMMAND] = kbdev->reg + 0x2f98;
	kbdev->regmap.regs[MMU_CONTROL__AS15__FAULTADDRESS] = kbdev->reg + 0x2fa0;
	kbdev->regmap.regs[MMU_CONTROL__AS15__FAULTSTATUS] = kbdev->reg + 0x2f9c;
	kbdev->regmap.regs[MMU_CONTROL__AS15__LOCKADDR] = kbdev->reg + 0x2f90;
	kbdev->regmap.regs[MMU_CONTROL__AS15__MEMATTR] = kbdev->reg + 0x2f88;
	kbdev->regmap.regs[MMU_CONTROL__AS15__STATUS] = kbdev->reg + 0x2fa8;
	kbdev->regmap.regs[MMU_CONTROL__AS15__TRANSCFG] = kbdev->reg + 0x2fb0;
	kbdev->regmap.regs[MMU_CONTROL__AS15__TRANSTAB] = kbdev->reg + 0x2f80;
	kbdev->regmap.regs[MMU_CONTROL__AS1__COMMAND] = kbdev->reg + 0x2898;
	kbdev->regmap.regs[MMU_CONTROL__AS1__FAULTADDRESS] = kbdev->reg + 0x28a0;
	kbdev->regmap.regs[MMU_CONTROL__AS1__FAULTSTATUS] = kbdev->reg + 0x289c;
	kbdev->regmap.regs[MMU_CONTROL__AS1__LOCKADDR] = kbdev->reg + 0x2890;
	kbdev->regmap.regs[MMU_CONTROL__AS1__MEMATTR] = kbdev->reg + 0x2888;
	kbdev->regmap.regs[MMU_CONTROL__AS1__STATUS] = kbdev->reg + 0x28a8;
	kbdev->regmap.regs[MMU_CONTROL__AS1__TRANSCFG] = kbdev->reg + 0x28b0;
	kbdev->regmap.regs[MMU_CONTROL__AS1__TRANSTAB] = kbdev->reg + 0x2880;
	kbdev->regmap.regs[MMU_CONTROL__AS2__COMMAND] = kbdev->reg + 0x2918;
	kbdev->regmap.regs[MMU_CONTROL__AS2__FAULTADDRESS] = kbdev->reg + 0x2920;
	kbdev->regmap.regs[MMU_CONTROL__AS2__FAULTSTATUS] = kbdev->reg + 0x291c;
	kbdev->regmap.regs[MMU_CONTROL__AS2__LOCKADDR] = kbdev->reg + 0x2910;
	kbdev->regmap.regs[MMU_CONTROL__AS2__MEMATTR] = kbdev->reg + 0x2908;
	kbdev->regmap.regs[MMU_CONTROL__AS2__STATUS] = kbdev->reg + 0x2928;
	kbdev->regmap.regs[MMU_CONTROL__AS2__TRANSCFG] = kbdev->reg + 0x2930;
	kbdev->regmap.regs[MMU_CONTROL__AS2__TRANSTAB] = kbdev->reg + 0x2900;
	kbdev->regmap.regs[MMU_CONTROL__AS3__COMMAND] = kbdev->reg + 0x2998;
	kbdev->regmap.regs[MMU_CONTROL__AS3__FAULTADDRESS] = kbdev->reg + 0x29a0;
	kbdev->regmap.regs[MMU_CONTROL__AS3__FAULTSTATUS] = kbdev->reg + 0x299c;
	kbdev->regmap.regs[MMU_CONTROL__AS3__LOCKADDR] = kbdev->reg + 0x2990;
	kbdev->regmap.regs[MMU_CONTROL__AS3__MEMATTR] = kbdev->reg + 0x2988;
	kbdev->regmap.regs[MMU_CONTROL__AS3__STATUS] = kbdev->reg + 0x29a8;
	kbdev->regmap.regs[MMU_CONTROL__AS3__TRANSCFG] = kbdev->reg + 0x29b0;
	kbdev->regmap.regs[MMU_CONTROL__AS3__TRANSTAB] = kbdev->reg + 0x2980;
	kbdev->regmap.regs[MMU_CONTROL__AS4__COMMAND] = kbdev->reg + 0x2a18;
	kbdev->regmap.regs[MMU_CONTROL__AS4__FAULTADDRESS] = kbdev->reg + 0x2a20;
	kbdev->regmap.regs[MMU_CONTROL__AS4__FAULTSTATUS] = kbdev->reg + 0x2a1c;
	kbdev->regmap.regs[MMU_CONTROL__AS4__LOCKADDR] = kbdev->reg + 0x2a10;
	kbdev->regmap.regs[MMU_CONTROL__AS4__MEMATTR] = kbdev->reg + 0x2a08;
	kbdev->regmap.regs[MMU_CONTROL__AS4__STATUS] = kbdev->reg + 0x2a28;
	kbdev->regmap.regs[MMU_CONTROL__AS4__TRANSCFG] = kbdev->reg + 0x2a30;
	kbdev->regmap.regs[MMU_CONTROL__AS4__TRANSTAB] = kbdev->reg + 0x2a00;
	kbdev->regmap.regs[MMU_CONTROL__AS5__COMMAND] = kbdev->reg + 0x2a98;
	kbdev->regmap.regs[MMU_CONTROL__AS5__FAULTADDRESS] = kbdev->reg + 0x2aa0;
	kbdev->regmap.regs[MMU_CONTROL__AS5__FAULTSTATUS] = kbdev->reg + 0x2a9c;
	kbdev->regmap.regs[MMU_CONTROL__AS5__LOCKADDR] = kbdev->reg + 0x2a90;
	kbdev->regmap.regs[MMU_CONTROL__AS5__MEMATTR] = kbdev->reg + 0x2a88;
	kbdev->regmap.regs[MMU_CONTROL__AS5__STATUS] = kbdev->reg + 0x2aa8;
	kbdev->regmap.regs[MMU_CONTROL__AS5__TRANSCFG] = kbdev->reg + 0x2ab0;
	kbdev->regmap.regs[MMU_CONTROL__AS5__TRANSTAB] = kbdev->reg + 0x2a80;
	kbdev->regmap.regs[MMU_CONTROL__AS6__COMMAND] = kbdev->reg + 0x2b18;
	kbdev->regmap.regs[MMU_CONTROL__AS6__FAULTADDRESS] = kbdev->reg + 0x2b20;
	kbdev->regmap.regs[MMU_CONTROL__AS6__FAULTSTATUS] = kbdev->reg + 0x2b1c;
	kbdev->regmap.regs[MMU_CONTROL__AS6__LOCKADDR] = kbdev->reg + 0x2b10;
	kbdev->regmap.regs[MMU_CONTROL__AS6__MEMATTR] = kbdev->reg + 0x2b08;
	kbdev->regmap.regs[MMU_CONTROL__AS6__STATUS] = kbdev->reg + 0x2b28;
	kbdev->regmap.regs[MMU_CONTROL__AS6__TRANSCFG] = kbdev->reg + 0x2b30;
	kbdev->regmap.regs[MMU_CONTROL__AS6__TRANSTAB] = kbdev->reg + 0x2b00;
	kbdev->regmap.regs[MMU_CONTROL__AS7__COMMAND] = kbdev->reg + 0x2b98;
	kbdev->regmap.regs[MMU_CONTROL__AS7__FAULTADDRESS] = kbdev->reg + 0x2ba0;
	kbdev->regmap.regs[MMU_CONTROL__AS7__FAULTSTATUS] = kbdev->reg + 0x2b9c;
	kbdev->regmap.regs[MMU_CONTROL__AS7__LOCKADDR] = kbdev->reg + 0x2b90;
	kbdev->regmap.regs[MMU_CONTROL__AS7__MEMATTR] = kbdev->reg + 0x2b88;
	kbdev->regmap.regs[MMU_CONTROL__AS7__STATUS] = kbdev->reg + 0x2ba8;
	kbdev->regmap.regs[MMU_CONTROL__AS7__TRANSCFG] = kbdev->reg + 0x2bb0;
	kbdev->regmap.regs[MMU_CONTROL__AS7__TRANSTAB] = kbdev->reg + 0x2b80;
	kbdev->regmap.regs[MMU_CONTROL__AS8__COMMAND] = kbdev->reg + 0x2c18;
	kbdev->regmap.regs[MMU_CONTROL__AS8__FAULTADDRESS] = kbdev->reg + 0x2c20;
	kbdev->regmap.regs[MMU_CONTROL__AS8__FAULTSTATUS] = kbdev->reg + 0x2c1c;
	kbdev->regmap.regs[MMU_CONTROL__AS8__LOCKADDR] = kbdev->reg + 0x2c10;
	kbdev->regmap.regs[MMU_CONTROL__AS8__MEMATTR] = kbdev->reg + 0x2c08;
	kbdev->regmap.regs[MMU_CONTROL__AS8__STATUS] = kbdev->reg + 0x2c28;
	kbdev->regmap.regs[MMU_CONTROL__AS8__TRANSCFG] = kbdev->reg + 0x2c30;
	kbdev->regmap.regs[MMU_CONTROL__AS8__TRANSTAB] = kbdev->reg + 0x2c00;
	kbdev->regmap.regs[MMU_CONTROL__AS9__COMMAND] = kbdev->reg + 0x2c98;
	kbdev->regmap.regs[MMU_CONTROL__AS9__FAULTADDRESS] = kbdev->reg + 0x2ca0;
	kbdev->regmap.regs[MMU_CONTROL__AS9__FAULTSTATUS] = kbdev->reg + 0x2c9c;
	kbdev->regmap.regs[MMU_CONTROL__AS9__LOCKADDR] = kbdev->reg + 0x2c90;
	kbdev->regmap.regs[MMU_CONTROL__AS9__MEMATTR] = kbdev->reg + 0x2c88;
	kbdev->regmap.regs[MMU_CONTROL__AS9__STATUS] = kbdev->reg + 0x2ca8;
	kbdev->regmap.regs[MMU_CONTROL__AS9__TRANSCFG] = kbdev->reg + 0x2cb0;
	kbdev->regmap.regs[MMU_CONTROL__AS9__TRANSTAB] = kbdev->reg + 0x2c80;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__TEXTURE_FEATURES] = kbdev->reg + 0x360;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__AMBA_FEATURES] = kbdev->reg + 0x120;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__CORE_FEATURES] = kbdev->reg + 0x300;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__DOORBELL_FEATURES] = kbdev->reg + 0x60;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__GPU_FEATURES] = kbdev->reg + 0x20;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__GPU_ID] = kbdev->reg + 0x0;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__L2_FEATURES] = kbdev->reg + 0x128;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__MCU_FEATURES] = kbdev->reg + 0x40;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__MEM_FEATURES] = kbdev->reg + 0x100;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__MMU_FEATURES] = kbdev->reg + 0x108;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__PRFCNT_FEATURES] = kbdev->reg + 0x50;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__REVIDR] = kbdev->reg + 0x8;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC0] = kbdev->reg + 0x2110;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC1] = kbdev->reg + 0x2114;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC2] = kbdev->reg + 0x2118;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC3] = kbdev->reg + 0x211c;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC4] = kbdev->reg + 0x2120;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC5] = kbdev->reg + 0x2124;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC6] = kbdev->reg + 0x2128;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_ALLOC7] = kbdev->reg + 0x212c;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_PBHA_OVERRIDE0] = kbdev->reg + 0x2100;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_PBHA_OVERRIDE1] = kbdev->reg + 0x2104;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_PBHA_OVERRIDE2] = kbdev->reg + 0x2108;
	kbdev->regmap.regs[MMU_CONTROL__SYSC_PBHA_OVERRIDE3] = kbdev->reg + 0x210c;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_FEATURES] = kbdev->reg + 0x320;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_BARRIER_SIZE] =
		kbdev->reg + 0x338;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_THREADS] =
		kbdev->reg + 0x330;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_WORKGROUP_SIZE] =
		kbdev->reg + 0x334;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__TILER_FEATURES] = kbdev->reg + 0x200;
	kbdev->regmap.regs[GPU_CONTROL__AMBA_ENABLE] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__AS_PRESENT] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__CSF_CONFIG] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__L2C_SLICE_HASH_0] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__L2C_SLICE_HASH_1] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__L2C_SLICE_HASH_2] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__L2_CONFIG] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__L2_MMU_CONFIG] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__NEURAL_CONFIG] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__PWR_KEY] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__PWR_OVERRIDE0] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__PWR_OVERRIDE1] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__SHADER_CONFIG] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__TEXTURE_FEATURES_1] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__TEXTURE_FEATURES_2] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__TEXTURE_FEATURES_3] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__TILER_CONFIG] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_CORE_MASK] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_FEATURES] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__COMMAND] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_CSHW] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_MEMSYS] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_NEURAL] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_SHADER] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_TILER] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__STATUS] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__TIMER] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_0] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_1] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_2] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_3] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_4] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_5] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_6] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_7] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_0] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_1] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_2] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_3] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_4] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_5] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_6] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_7] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_0] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_1] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_2] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_3] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_4] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_5] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_6] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_0] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_1] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_2] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_3] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_4] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_5] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_6] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_7] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_0] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_1] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_2] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_3] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_4] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_5] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_6] = NULL;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_7] = NULL;
}

static void kbase_regmap_v15_8_init(struct kbase_device *kbdev)
{
	if (kbdev->regmap.regs == NULL && kbdev->regmap.flags == NULL) {
		kbdev->regmap.size = NR_V15_8_REGS;
		kbdev->regmap.regs =
			kcalloc(kbdev->regmap.size, sizeof(void __iomem *), GFP_KERNEL);
		kbdev->regmap.flags = kcalloc(kbdev->regmap.size, sizeof(u32), GFP_KERNEL);
	}
	...
	kbase_regmap_v14_10_init(kbdev);

	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_CG_U_FAULT_HANDLED] = KBASE_REGMAP_WIDTH_32_BIT |
									 KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_CG_U_FAULT_STATUS] = KBASE_REGMAP_WIDTH_32_BIT |
									KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_NUM_ACTIVE_GRANULARITY] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_FAULT_REPORT] = KBASE_REGMAP_WIDTH_32_BIT |
								   KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_GL_U_FAULT_HANDLED] = KBASE_REGMAP_WIDTH_32_BIT |
									 KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_GL_U_FAULT_STATUS] = KBASE_REGMAP_WIDTH_32_BIT |
									KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_HI] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_LO] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_HI] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_LO] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_BARRIER_SIZE] = 0;
	kbdev->regmap.flags[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_WORKGROUP_SIZE] = 0;

	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_CG_U_FAULT_HANDLED] = kbdev->reg + 0x910;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_CG_U_FAULT_STATUS] = kbdev->reg + 0x810;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_NUM_ACTIVE_GRANULARITY] =
		kbdev->reg + 0x334;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_FAULT_REPORT] = kbdev->reg + 0xb00;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_GL_U_FAULT_HANDLED] = kbdev->reg + 0x920;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_GL_U_FAULT_STATUS] = kbdev->reg + 0x820;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_HI] = kbdev->reg + 0x908;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_LO] = kbdev->reg + 0x900;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_HI] = kbdev->reg + 0x808;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_LO] = kbdev->reg + 0x800;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_BARRIER_SIZE] = NULL;
	kbdev->regmap.regs[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_MAX_WORKGROUP_SIZE] = NULL;
}
...
u32 kbase_regmap_backend_init(struct kbase_device *kbdev)
{
	...
	struct {
		...
		{ GPU_ID_ARCH_MAKE(14, 10, 0), kbase_regmap_v14_10_init },
		{ GPU_ID_ARCH_MAKE(15, 8, 0), kbase_regmap_v15_8_init },
	};
...
static char *enum_strings[] = {
	...
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7",
	[WINDOW_CONTROL__WINDOW_IRQ_CLEAR] = "WINDOW_CONTROL__WINDOW_IRQ_CLEAR",
	[WINDOW_CONTROL__WINDOW_IRQ_MASK] = "WINDOW_CONTROL__WINDOW_IRQ_MASK",
	[WINDOW_CONTROL__WINDOW_IRQ_RAWSTAT] = "WINDOW_CONTROL__WINDOW_IRQ_RAWSTAT",
	[WINDOW_CONTROL__WINDOW_IRQ_STATUS] = "WINDOW_CONTROL__WINDOW_IRQ_STATUS",
	...
	[WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE_STATUS] =
		"WINDOW_CONTROL__WINDOW_MESSAGE__AM_OUTGOING_MESSAGE_STATUS",
	[WINDOW_CONTROL__WINDOW_STATUS] = "WINDOW_CONTROL__WINDOW_STATUS",
	[WINDOW_CONTROL__WINDOW_CG_U_FAULT_HANDLED] = "WINDOW_CONTROL__WINDOW_CG_U_FAULT_HANDLED",
	[WINDOW_CONTROL__WINDOW_CG_U_FAULT_STATUS] = "WINDOW_CONTROL__WINDOW_CG_U_FAULT_STATUS",
	[WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_NUM_ACTIVE_GRANULARITY] =
		"WINDOW_CONTROL__WINDOW_DISCOVER__THREAD_NUM_ACTIVE_GRANULARITY",
	[WINDOW_CONTROL__WINDOW_FAULT_REPORT] = "WINDOW_CONTROL__WINDOW_FAULT_REPORT",
	[WINDOW_CONTROL__WINDOW_GL_U_FAULT_HANDLED] = "WINDOW_CONTROL__WINDOW_GL_U_FAULT_HANDLED",
	[WINDOW_CONTROL__WINDOW_GL_U_FAULT_STATUS] = "WINDOW_CONTROL__WINDOW_GL_U_FAULT_STATUS",
	[WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_HI] =
		"WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_HI",
	[WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_LO] =
		"WINDOW_CONTROL__WINDOW_SC_U_FAULT_HANDLED_LO",
	[WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_HI] =
		"WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_HI",
	[WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_LO] =
		"WINDOW_CONTROL__WINDOW_SC_U_FAULT_STATUS_LO",
};
