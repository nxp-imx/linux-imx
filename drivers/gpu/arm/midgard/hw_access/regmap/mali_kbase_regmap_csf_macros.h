...
#define WINDOW_CONTROL_ENUM(regname) WINDOW_CONTROL__##regname
#define WINDOW_MESSAGE_ENUM(regname) WINDOW_CONTROL_ENUM(WINDOW_MESSAGE__##regname)

#define WINDOW_DISCOVER_ENUM(regname) WINDOW_CONTROL_ENUM(WINDOW_DISCOVER__##regname)
...
/* WINDOW_IRQ_STATUS values */
#define WINDOW_IRQ_MESSAGE 0x1
#define WINDOW_IRQ_INVALID_ACCESS (0x1 << 1)
#define WINDOW_IRQ_WINDOW_OPENING (0x1 << 2)
#define WINDOW_IRQ_WINDOW_OPENED (0x1 << 3)
#define WINDOW_IRQ_WINDOW_CLOSED (0x1 << 4)
#define WINDOW_IRQ_REG_ALL                                                            \
	(WINDOW_IRQ_MESSAGE | WINDOW_IRQ_INVALID_ACCESS | WINDOW_IRQ_WINDOW_OPENING | \
	 WINDOW_IRQ_WINDOW_OPENED | WINDOW_IRQ_WINDOW_CLOSED)
...
#define AS_FAULTSTATUS_EXCEPTION_TYPE_NX_DATA_INVALID_FAULT 0x61
#define AS_FAULTSTATUS_EXCEPTION_TYPE_NX_ADDR_RANGE_FAULT 0x62
#define AS_FAULTSTATUS_EXCEPTION_TYPE_NX_TSU_SPACE_FAULT 0x63
#define AS_FAULTSTATUS_EXCEPTION_TYPE_NX_TSU_INVALID_ENC 0x64
#define AS_FAULTSTATUS_EXCEPTION_TYPE_NX_WEIGHT_STREAM_ERROR 0x65
...
#define GPU_FAULTSTATUS_ACCESS_TYPE_READ_WRITE 0x0
...
#define GPU_FEATURES_NEURAL_ACCELERATOR_SHIFT GPU_U(4)
#define GPU_FEATURES_NEURAL_ACCELERATOR_MASK (GPU_U(0x1) << GPU_FEATURES_NEURAL_ACCELERATOR_SHIFT)
/* End of GPU_FEATURES register */
...
#define WINDOW_STATUS_IRQ_WINDOW_CONTROL (1 << 0)
#define WINDOW_STATUS_IRQ_GPU_CONTROL (1 << 1)
#define WINDOW_STATUS_IRQ_GPU_POWER (1 << 2)
#define WINDOW_STATUS_IRQ_JOB_CONTROL (1 << 3)
#define WINDOW_STATUS_IRQ_MMU_CONTROL (1 << 4)
#define WINDOW_STATUS_WINDOW_OPEN (0x1 << 31)
