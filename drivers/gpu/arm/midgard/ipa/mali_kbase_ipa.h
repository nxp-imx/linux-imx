...
/*
 *
 * (C) COPYRIGHT 2016-2026 ARM Limited. All rights reserved.
 *
 ...
 * @KBASE_IPA_BLOCK_TYPE_NEURAL_ACCELERATORS: All Neural Accelerators.
...
enum kbase_ipa_block_type {
	...
	KBASE_IPA_BLOCK_TYPE_NEURAL_ACCELERATORS,
