 ...
 * @neural_accelerators_cntrs_def: Array of description of HW counters used by the IPA
 *                       counter model for neural accelerators.
 * @num_neural_accelerators_cntrs: Number of elements in @neural_accelerators_cntrs_def_array.
...
struct kbase_ipa_counter_model_data {
	...
	const struct kbase_ipa_counter *neural_accelerators_cntrs_def;
	size_t num_neural_accelerators_cntrs;
 ...
 * @neural_accelerators_cntrs_def: Array corresponding to the HW counters used in the
 *                       neural accelerators counter model, contains the counter index,
 *                       default value of the coefficient.
 * @num_neural_accelerators_cntrs: Number of elements in the array
 *                          @neural_accelerators_cntrs_def.
 * @reference_voltage:   voltage, in mV, of the operating point used when
...
int kbase_ipa_counter_common_model_init(struct kbase_ipa_model *model,
					...
					const struct kbase_ipa_counter *shader_cores_cntrs_def,
					size_t num_shader_cores_cntrs,
						const struct kbase_ipa_counter
						*neural_accelerators_cntrs_def,
						size_t num_neural_accelerators_cntrs,
						s32 reference_voltage);
/**
