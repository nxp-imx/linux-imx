...
#define SMC_VPU_BATCH_WRITE SMC_FASTCALL_NR(SMC_ENTITY_VPU, 3)
#define SMC_VPU_BATCH_READ  SMC_FASTCALL_NR(SMC_ENTITY_VPU, 4)
#define SMC_VPU_BATCH_MAP   SMC_FASTCALL_NR(SMC_ENTITY_VPU, 5)
#define SMC_VPU_BATCH_UNMAP SMC_FASTCALL_NR(SMC_ENTITY_VPU, 6)

#define BATCH_SHM_WRITE 0
#define BATCH_SHM_READ  1

#define VPU_BATCH_REG_MAX_ENTRIES  128

struct vpu_batch_reg_entry {
	u32 offset;
	u32 value;
};
