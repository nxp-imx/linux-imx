...
#define PMA_MPLLB_CTRL2_V2_MPLLB_DIV_MULT_MASK	GENMASK(7, 0)
#define PMA_MPLLB_CTRL2_V2_MPLLB_DIV_MULT(x)	((x) & GENMASK(7, 0))
#define PMA_MPLLB_CTRL2_V2_MPLLB_DIV8_CLK_EN	BIT(8)
#define PMA_MPLLB_CTRL2_V2_MPLLB_DIV10_CLK_EN	BIT(9)
#define PMA_MPLLB_CTRL2_V2_MPLLB_DIV_CLK_EN	BIT(10)
#define PMA_MPLLB_CTRL2_V2_MPLLB_TX_CLK_DIV_MASK	GENMASK(13, 11)
#define PMA_MPLLB_CTRL2_V2_MPLLB_TX_CLK_DIV(x)	(((x) << 11) & GENMASK(13, 11))
#define PMA_MPLLB_CTRL2_V2_MPLLB_WRD_DIV2_EN	BIT(15)
...
static int imx952_xpcs_phy_mpllb_configuration_xaui_kx4(struct dw_xpcs *xpcs)
{
	int ret;
	...
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_25G_REF_CLK_CTRL,
			PMA_REF_CLK_CTRL_REF_MPLLB_DIV2,
			PMA_REF_CLK_CTRL_REF_MPLLB_DIV2);
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_MPLLB_CTRL0,
			PMA_MPLLB_CTRL0_MPLLB_MULTIPLIER_MASK,
			PMA_MPLLB_CTRL0_MPLLB_MULTIPLIER(0x7D)); //DEC 125
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_MPLLB_CTRL0,
			PMA_MPLLB_CTRL0_MPLLB_CAL_DISABLE, 0);
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_MPLLB_CTRL1,
			PMA_MPLLB_CTRL1_MPLLB_FRACN_CTRL_MASK,
			PMA_MPLLB_CTRL1_MPLLB_FRACN_CTRL(0x0));
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_MPLLB_CTRL2,
			PMA_MPLLB_CTRL2_V2_MPLLB_TX_CLK_DIV_MASK,
			PMA_MPLLB_CTRL2_V2_MPLLB_TX_CLK_DIV(0x5));
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_MPLLB_CTRL2,
			PMA_MPLLB_CTRL2_V2_MPLLB_DIV10_CLK_EN,
			PMA_MPLLB_CTRL2_V2_MPLLB_DIV10_CLK_EN);
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_MPLLB_CTRL2,
			PMA_MPLLB_CTRL2_V2_MPLLB_DIV8_CLK_EN, 0);
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_MPLLB_CTRL2,
			PMA_MPLLB_CTRL2_V2_MPLLB_WRD_DIV2_EN, 0);
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2, PMA_MP_16G_MPLLB_CTRL3,
			PMA_MPLL_CTRL3_MPLLB_BANDWIDTH_MASK,
			PMA_MPLL_CTRL3_MPLLB_BANDWIDTH(0x3f)); //DEC 63
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_12G_16G_25G_VCO_CAL_LD0,
			PMA_VCO_CAL_LD0_VCO_LD_VAL_0_MASK,
			PMA_VCO_CAL_LD0_VCO_LD_VAL_0(0x546)); //DEC 1350
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			PMA_MP_16G_25G_VCO_CAL_REF0,
			PMA_VCO_CAL_REF0_V2_VCO_REF_LD_0_MASK,
			PMA_VCO_CAL_REF0_V2_VCO_REF_LD_0(0x1b)); //DEC 27
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
	...
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			...
			PMA_RX_CDR_CTRL_VCO_LOW_FREQ_0,
			PMA_RX_CDR_CTRL_VCO_LOW_FREQ_0);
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2, MII_DIG_CTRL1,
			MII_DIG_CTRL1_VR_RST, MII_DIG_CTRL1_VR_RST);
	...
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
			...
			PMA_TX_EQ_CTRL0_TX_EQ_MAIN(0x18)); //DEC 24
	xpcs_phy_modify(xpcs, XPCS_DEV, MDIO_MMD_VEND2,
...
static int imx952_xpcs_phy_mpll_sel(struct dw_xpcs *xpcs, bool is_2p5g)
{
	u16 val;
	int ret;
...
static int imx952_xpcs_phy_sgmii_config(struct dw_xpcs *xpcs, bool is_2p5g)
{
	int ret;

	ret = imx952_xpcs_phy_mpll_sel(xpcs, is_2p5g);
	if (ret)
		return ret;
	...
	if (is_2p5g)
		ret = imx952_xpcs_phy_mpllb_configuration_xaui_kx4(xpcs);
	else
...
int imx952_xpcs_phy_sgmii_2p5g_config(struct dw_xpcs *xpcs)
{
	return imx952_xpcs_phy_sgmii_config(xpcs, true);
}

int imx952_xpcs_phy_sgmii_1g_config(struct dw_xpcs *xpcs)
{
	return imx952_xpcs_phy_sgmii_config(xpcs, false);
}
