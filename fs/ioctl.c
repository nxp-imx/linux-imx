...
EXPORT_SYMBOL_NS(fiemap_fill_next_extent, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
...
EXPORT_SYMBOL_NS(fiemap_prep, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
