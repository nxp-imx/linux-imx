...
EXPORT_SYMBOL_NS(make_bad_inode, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
...
EXPORT_SYMBOL_NS(is_bad_inode, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
