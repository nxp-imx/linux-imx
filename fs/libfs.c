...
EXPORT_SYMBOL_NS(generic_read_dir, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
...
EXPORT_SYMBOL_NS(__generic_file_fsync, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
...
EXPORT_SYMBOL_NS(generic_file_fsync, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
