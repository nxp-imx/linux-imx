...
EXPORT_SYMBOL_NS_GPL(vfs_setxattr, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
...
EXPORT_SYMBOL_NS_GPL(vfs_getxattr, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
...
EXPORT_SYMBOL_NS_GPL(vfs_listxattr, "ANDROID_GKI_VFS_internal_I_am_really_a_filesystem_and_am_NOT_a_driver");
